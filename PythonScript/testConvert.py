...
class TestConvert(unittest.TestCase):
    ...
    def test_add_superscript(self):
        ...
        self.assertEqual('<font class="intro">' + u"入" +
                         "</font>", CheckedToneMarker(u"入").mark_book())
        self.assertEqual('江<font class="intro">入</font>' +
                         '<font class="intro">日</font>', CheckedToneMarker("江入日").mark_book())
        # self.assertEqual(u"江^入^^日^", CheckedToneMarker(u"江入日").mark_book())
        self.assertEqual(u"江~屋~" + '<font class="intro">' + u"日" + "</font>", CheckedToneMarker(u"江~屋~日").mark_book(),
